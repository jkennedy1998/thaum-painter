...
- source-of-truth from J: a RECENT section locked to the top of the module, keeping the last ~10 selected graphics (sprite or glyph) for quick recall while the rest scrolls under it.
